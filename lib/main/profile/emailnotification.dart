...
class _State extends State<EmailNotification> {
        ...
        body: Container(
            ...
            child: ListView(
              children: <Widget>[
                ...
                Container(
                    height: 48,
                    margin: EdgeInsets.only(left:16, right: 16, top: 540, bottom: 14),
                    child: RaisedButton(
